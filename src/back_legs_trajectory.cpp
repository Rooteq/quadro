...
private:
  // void apply_basic_ik(const double x, const double y, const double z, double& q1, double& q2, double&q3)
  // {
  //   double alfa;
  ...
  void ik_br_leg_joints(const double x, double y, const double z)
  {
    double q1, q2, q3;
  ...
  void ik_bl_leg_joints(const double x, double y, const double z)
  {
    double q1, q2, q3;
    // apply_basic_ik(x,y,z,q1,q2,q3);
    // y offset
  ...
  void timer_callback()
  {
    ...
    trajectory_msg.joint_names = {"joint_br_1", "joint_br_2", "joint_br_3", "joint_bl_1", "joint_bl_2", "joint_bl_3"};
    double radius = 0.05;
